...
<body>
   <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
        <?php $jum=(isset($_POST['jum'])?$_POST['jum']: 2) ; ?>
         Tampilkan sebanyak : <select name="jum">
           <option value="5" <?php echo $jum==1?"selected": ''; ?>>5</option>
           <option value="10" <?php echo $jum==2?"selected": ''; ?>>10</option>
           <option value="15" <?php echo $jum==5?"selected": ''; ?>>15</option>
           <option value="20" <?php echo $jum==10?"selected": ''; ?>>20</option>
           <option value="25" <?php echo $jum==15?"selected": ''; ?>>25</option>
           </select>
